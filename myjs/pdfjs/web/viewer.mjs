...
(store.versions || (store.versions = [])).push({
  ...
  copyright: '漏 2014-2024 Denis Pushkarev (zloirock.ru)',
  ...
  constructor(source) {
    ...
    function parseEscapeSequence() {
      ...
      if (test(RE_UNICODE_ESCAPE)) {
        ...
        return codepoint <= 0xd7ff || 0xe000 <= codepoint ? String.fromCodePoint(codepoint) : "锟�";
      }
...
function getNormalizeWithNFKC() {
  NormalizeWithNFKC ||= `聽篓陋炉虏-碌赂-潞录-戮牟-某目-艀艍趴莿-菍潜-浅拾-矢藰-藵藸-摔痛秃途蝿-螀螄蠍-蠔习-喜洗-系瞎謬俚-俑啷�-啷熰-唰澿啜赤ǘ喋�-喋涏喹�-喹澿赋嗪赤粶-嗷澿紝嘟冟綅嘟掄綏嘟溹僵醿坚船-岽窗-岽横醇-岬嶀祻-岬蹈岫�-岫酷簹-岷涐奖峤翅降峤丰焦峤会浇峋会窘-峥佱繅峥嬦繊-峥忈繐峥涐繚-峥熱浚峥凯-峥抗峥会拷-峥锯€€-鈥娾€戔€椻€�-鈥︹€€�-鈥粹€�-鈥封€尖€锯亣-鈦夆仐鈦熲伆-鈦扁伌-鈧庘倫-鈧溾偍鈩€-鈩冣剠-鈩団剦-鈩撯剷-鈩栤剻-鈩濃劆-鈩⑩劋鈩︹劏鈩�-鈩劘-鈩扁劤-鈩光劵-鈪€鈪�-鈪夆厫-鈪库唹鈭�-鈭埊-鈭扳尒-鈱憼-鈸▽猢�-猢垛珳獗�-獗解弹夂熲怀饧€-饪曘€€銆躲€�-銆恒倹-銈溿偀銉裤劚-銌庛啋-銌熴垁-銏炪垹-銐囥墣-銐俱妧-銖筷殰-隁濌澃隉�-隉搓煾-隉龟瓬-戥熽铯€-铷嶏◥铷掞〞-铷烇铷ē-铷︼í-铹┌-铽欙瑎-铿嗭瑩-铿楋瑵铿�-铿讹-铿硷锃€-锃侊瓋-锃勶瓎-锂憋瘬-锎斤祼-锒忥稈-锓囷钒-锓硷笎-锔欙赴-锕勶箛-锕掞箶-锕︼龚-锕拱-锕诧勾锕�-锘硷紒-锞撅總-锟囷繆-锟忥繏-锟楋繗-锟滐繝-锟;
